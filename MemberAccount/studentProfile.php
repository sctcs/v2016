...
if ( $_GET[whose] == "spouse") {
	$SQLstring = "SELECT count(*) as cnt FROM `tblMember`,tblLogin WHERE tblMember.MemberID=tblLogin.MemberID and FamilyID=".$_SESSION['family_id']
	            ." and MemberTypeID=15 and tblLogin.MemberID != ".$_SESSION['memberid'];
				...
				<tr>
					...
					<td align="center" valign="top">
                        ...
                        ?>
							...
							<?php if ( $seclvl != 30 ) { // not student ?>
 							<tr>
								<td align="left"><a href="FamilyChildList.php">[Student List]
										<a href="studentClassesRegistered.php?stuid=<?php echo $_GET['stuid'];?>">[Registered Classes]</a>
										<a href="studentRegisterClass.php?stuid=<?php echo $_GET['stuid'];?>">[Register Classes]</a></
							...
							<tr>
								<td bgcolor="#000000">
									<table CLASS="page" bgcolor="#FFFFFF" border="0" width="100%">
										...
										<tr>
											<td width="50%" align="Right"><font color="red">Student Point:</font></td>
											<td width="50%" align="left"><?php echo $RSA1[StudentPoint];?></td>
										</tr>

										<tr>
											<td width="50%" align="Right">Last Update: </td>
											<td width="50%" align="left"><?php echo $RSA1[MostRecentUpdateDate];?></td>
										</tr>
