...
on charge.FamilyID=pay.FamilyID where charge.FamilyID=".$familyid;
...
" and FamilyID=".$familyid.  " group by FamilyID";
//echo $sql10;
...
" and FamilyID=".$familyid.  " and Amount<0 and ReceivableType != 'Registration'  group by FamilyID";
//echo $sql11;
...
" and FamilyID=".$familyid.  " and IncomeCategory='14' group by FamilyID";
