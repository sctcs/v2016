             ...
             if ($rc > 1) {   ?>       
                   ...
                   <table border="1" class="table table-striped">
                        <tr><th>English Name</th><th>Chinese Name</th><th>Member ID</th><th>Primary Contact</th>
                            <?php  if(isset($_SESSION['logon']) && ($seclvl== 10 || $seclvl == 20 || $seclvl ==40 || $seclvl == 55)) {echo '<th>Edit Member</th>'; }?>                   
                        ...
                        for ($i = 1; $i <= $rc; $i++) {
                            ...
                            <tr>
                              ...
                              <?php if(isset($_SESSION['logon']) && ($seclvl==10 || $seclvl == 20 ||$seclvl ==40 || $seclvl ==55)) {   ;?>
