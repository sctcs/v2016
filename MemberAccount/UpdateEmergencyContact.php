...
<!DOCTYPE html>
<head>
    <title>Member Emergency Contact Update</title>
...
<body>
    <div class="container">   
        ...
        //echo "seclvl=" . $seclvl . ", family_id=" . $family_id . ", memid=" . $memid . ", mid=" . $mid;

        if (!$seclvl && !isset($_SESSION['family_id']) && !isset($_POST[newmember]) && !isset($_GET['mid'])) {
...
//if(!isset($_SESSION['family_id']) && !isset($_POST[newmember]) && !isset($_GET['mid']) )
//{
// header( 'Location: ../main.php' ) ;
// exit();
//}
...
//echo "<br>SQLstring:  ".$SQLstring;
        ...
        <h3 class="text-center">Updated Successfully</h3>   
        <?php
        if (empty($_POST[whose])) {
            if (!empty($mid) && ($seclvl == 20 || $seclvl == 40)) {
                echo "<p class='alert alert-success center'>Member's emergency contact updated successfully.<span class='text-center'><br><br>Click here to check <a href=\"EmergencyContact.php?mid=" . $_GET['mid'] . "\"> Updated Member Emergency Contact </a> information <br>"
                . " Go back to<a href=\"MemberAccountMain.php\"> Member Account Main.</a></p>";
            }
        } else {
            if ($_POST[whose] == "student1") {
                ...
                echo "<p class='alert alert-success center'>Profile updated successfully.<br> Click here to <br><a href=\"studentProfile.php?whose=student&stuid=" . $_POST['updtmemberid'] . "\">continue</a><br>";
                echo "View <br><a href=\"FamilyChildList.php\">Child List</a></p>";
            } else {
                echo "<p class='alert alert-success center'>Profile updated successfully, click here to <a href=\"FamilyChildList.php\">continue</a></p>";
            }
        }
        ?>
    </div>
